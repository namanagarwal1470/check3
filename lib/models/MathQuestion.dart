...
class MathQuestion {
  ...
  factory MathQuestion.fromMap(Map<String,dynamic> map,List<DocumentSnapshot> passage_snapshot){
  ...
  return MathQuestion(
    ...
    tp=='STATEMENT'?STATEMENT_Question.fromMap(map['questions']) :null//PB_Question.fromMap(map,passage_snapshot)
    ) ;
  }
}
...
class SOC_Question{
  ...
  late int answer;
  SOC_Question({required this.image,required this.title,required this.tag,required this.solution,required this.options,required this.answer});
...
class MOC_Question{
  ...
  MOC_Question({required this.image,required this.title,required this.tag,required this.solution,required this.options,required this.answer});
...
class PB_Question{
  ...
  factory PB_Question.fromMap(Map<String,dynamic> map,List<DocumentSnapshot> passage_snapshot){
    return PB_Question(
      tag: map['tag'],
      sub_questions: (List.castFrom(map['questions']) as List<String>).map((e) => SOC_Question.fromMap(passage_snapshot.where((element) => element.id==e).toList()[0].data())).toList(),
    ) ;
  }
}
class STATEMENT_Question{
  ...
  late String solution;
  late int answer;
  STATEMENT_Question({required this.image,required this.title,required this.tag,required this.solution,required this.answer});
...
class IT_Question{
  ...
  late String solution;
  late int answer;
  IT_Question({required this.image,required this.title,required this.tag,required this.solution,required this.answer});
